...
class ThemeManager:
    ...
    def load_and_apply(self):
        ...
        if settings and settings.get("theme_name") == "custom":
            ...
            self.apply_colors(
                bg_hex=settings.get("bg_color", "
                text_hex=settings.get("text_color", "
                field_bg_hex=settings.get("field_bg_color", "
                btn_save=settings.get("button_save_color", "
                btn_danger=settings.get("button_danger_color", "
                btn_info=settings.get("button_info_color", "
                btn_edit=settings.get("button_edit_color", "
                btn_normal=settings.get("button_normal_color", "
                btn_save_text=settings.get("button_save_text", "
                btn_danger_text=settings.get("button_danger_text", "
                btn_info_text=settings.get("button_info_text", "
                btn_edit_text=settings.get("button_edit_text", "
                btn_normal_text=settings.get("button_normal_text", "
                selection_text=settings.get("selection_text", "
    ...
    def apply_colors(self, bg_hex, text_hex, field_bg_hex=None,
                     ...
                     selection_text="
        bg = QColor(bg_hex or "
        txt = QColor(text_hex or "
        field_bg = QColor(field_bg_hex or bg_hex or "
