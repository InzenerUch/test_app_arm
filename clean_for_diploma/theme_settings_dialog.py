...
class ThemeSettingsDialog(QDialog):
    def __init__(self, theme_manager, parent=None):
        ...
        self.btn_info_color = "
        self.btn_edit_color = "
        self.btn_normal_color = "
        self.btn_save_text = "
        self.btn_danger_text = "
        self.btn_info_text = "
        self.btn_edit_text = "
        self.btn_normal_text = "
        self.selection_text = "
        self.font_size = 12
        self.init_ui()
    ...
    def init_ui(self):
        ...
        apply_btn.setStyleSheet("background-color:
        apply_btn.clicked.connect(self.on_apply)
        reset_btn = QPushButton("🔄 Сбросить")
        reset_btn.setStyleSheet("background-color:
    ...
    def _style_btn(self, btn, color):
        ...
        btn.setStyleSheet(f"""
            QPushButton {{ background-color: {color}; color: {contrast}; border: 1px solid
        """)
