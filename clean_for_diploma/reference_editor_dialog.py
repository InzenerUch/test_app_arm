...
from record_edit_dialog import RecordEditDialog
class ReferenceEditorDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.add_btn.setStyleSheet("QPushButton { background-color:
        self.add_btn.clicked.connect(self.add_record)
        toolbar_layout.addWidget(self.add_btn)
        self.edit_btn = QPushButton("✏️ Редактировать")
        self.edit_btn.setStyleSheet("QPushButton { background-color:
        self.edit_btn.clicked.connect(self.edit_record)
        self.edit_btn.setEnabled(False)
        toolbar_layout.addWidget(self.edit_btn)
        self.delete_btn = QPushButton("🗑️ Удалить")
        self.delete_btn.setStyleSheet("QPushButton { background-color:
