...
class CompositeFieldWidget:
    ...
    def _create_composite_column_widget(self, row, idx, col_info, table_name):
        ...
        num_label.setStyleSheet("font-weight: bold; color:
        ...
        remove_btn.setStyleSheet("QPushButton { background-color:
    ...
    def _add_add_column_button(self, layout, row, table_name=None):
        ...
        add_col_btn.setStyleSheet("QPushButton { background-color:
