...
class TemplateEditDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.file_label.setStyleSheet("QLabel { color:
    ...
    def choose_file(self):
        ...
        if path:
            ...
            self.file_label.setStyleSheet("QLabel { color: green; font-weight: bold; background-color:
            self.download_file_btn.setEnabled(False)
    ...
    def load_data(self):
        ...
        if query.exec() and query.next():
            ...
            if data:
                ...
                self.file_label.setStyleSheet("QLabel { color: blue; font-weight: bold; background-color:
