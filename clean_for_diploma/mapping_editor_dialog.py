...
try:
    ...
    COLUMN_DESCRIPTIONS = {}
    DB_COLUMNS_MAP = {}
    def get_field_description(t, c): return c
class MappingEditorDialog(QDialog):
    ...
    def init_ui(self):
        ...
        info_label.setStyleSheet("QLabel { color:
        ...
        add_simple_btn.setStyleSheet("QPushButton { background-color:
        ...
        add_composite_btn.setStyleSheet("QPushButton { background-color:
